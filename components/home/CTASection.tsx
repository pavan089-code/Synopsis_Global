  ...
  return (
    <section className="relative overflow-hidden bg-[#16325B] py-20 text-white">
      ...
      <Reveal className="mx-auto max-w-4xl px-6 text-center lg:px-8">
        <p className="text-xs font-bold uppercase tracking-[0.24em] text-[#D7C19A]">Build what is next</p>
        <h2 className="mt-4 text-3xl font-semibold tracking-normal sm:text-4xl">Let&apos;s Build Your Digital Future</h2>
        <p className="mx-auto mt-5 max-w-2xl text-base leading-7 text-white/75">
          Talk to our experts about the technology, talent, and business priorities shaping your next phase of growth.
        </p>
        <div className="mt-9 flex flex-col justify-center gap-4 sm:flex-row">
          <InquiryButton>Schedule a Consultation</InquiryButton>
