...
export const companyStory = [
  "Synopsis Global supports students, professionals, and families as they navigate international education, visas, and immigration planning across borders.",
...
export const mission =
  "To guide people toward reliable global education and immigration pathways through ethical counselling, destination insight, and consistent documentation support.";
...
export const coreValues: CoreValue[] = [
  ...
  { title: "Excellence", body: "We bring discipline, detail, and quality control to applications, visa files, and documentation.", icon: Award },
  ...
  { title: "Commitment", body: "We stay close to clients through each stage of their education, visa, or immigration journey.", icon: UserCheck },
