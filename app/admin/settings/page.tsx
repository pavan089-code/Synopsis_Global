      ...
      <div className="grid gap-5">
        <section className={`border p-5 shadow-sm ${configured ? "border-emerald-200 bg-emerald-50" : "border-amber-200 bg-amber-50"}`}>
          <div className="flex items-start gap-3">
            ...
            <div>
              <h2 className="text-lg font-semibold text-[#082B6A]">Environment Status</h2>
        ...
        <section className="grid gap-4 border border-slate-200 bg-white p-5 shadow-sm">
          <h2 className="text-lg font-semibold text-[#082B6A]">Current Firebase Project</h2>
        ...
        <section className="grid gap-4 border border-slate-200 bg-white p-5 shadow-sm">
          <h2 className="text-lg font-semibold text-[#082B6A]">Current Admin User</h2>
          <dl className="grid gap-3 text-sm sm:grid-cols-2">
        ...
        <section className="grid gap-4 border border-slate-200 bg-white p-5 shadow-sm">
          <h2 className="text-lg font-semibold text-[#082B6A]">Required Variables</h2>
