...
function AdminLoginContent() {
  ...
  return (
    <main className="grid min-h-screen bg-[#082B6A] px-5 py-10 text-white lg:grid-cols-[1fr_520px]">
      <section className="flex items-center">
        <div className="mx-auto max-w-2xl">
          <p className="text-xs font-bold uppercase tracking-[0.22em] text-[#C9A227]">Synopsis Global</p>
      ...
      <section className="mx-auto flex w-full max-w-xl items-center">
        <form onSubmit={handleSubmit} className="w-full border border-white/15 bg-white p-6 text-slate-800 shadow-2xl">
          <div className="mb-8">
            <p className="text-xs font-bold uppercase tracking-[0.18em] text-[#C9A227]">Email Password Auth</p>
            <h2 className="mt-2 text-2xl font-semibold text-[#082B6A]">Sign in</h2>
          </div>
          ...
          <label className="grid gap-2 text-sm font-semibold text-[#082B6A]">
            Email
            <span className="flex min-h-12 items-center gap-3 border border-slate-300 px-3 focus-within:border-[#C9A227]">
          ...
          <label className="mt-5 grid gap-2 text-sm font-semibold text-[#082B6A]">
            Password
            <span className="flex min-h-12 items-center gap-3 border border-slate-300 px-3 focus-within:border-[#C9A227]">
          ...
          <button type="submit" disabled={submitting} className="mt-7 min-h-12 w-full bg-[#082B6A] px-5 text-sm font-bold uppercase tracking-[0.08em] text-white transition hover:bg-[#061f4f] disabled:opacity-60">
